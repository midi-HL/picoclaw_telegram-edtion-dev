      ...
      {audioAttachments.length > 0 && (
        <div className="mt-2 flex flex-col gap-2">
          {audioAttachments.map((attachment, index) => (
            <div
              key={`${attachment.url}-${index}`}
              className="border-border/60 bg-card flex w-full max-w-md items-center gap-3 rounded-xl border px-4 py-3"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-emerald-400 ring-1 ring-emerald-500/10 dark:bg-emerald-500/10 dark:text-emerald-400 dark:ring-emerald-500/30">
